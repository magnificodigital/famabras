<?php
    ...
    function my_general_section() {  
	    ...
	    add_settings_field( // Option 1
	        'linkedin_icon', // Option ID
	        'Endereço do linkedin', // Label
	        'my_textbox_callback', // !important - This is where the args go!
	        'general', // Page it will be displayed (General Settings)
	        'redes_sociais', // Name of our section
	        array( // The $args
	            'linkedin_icon' // Should match Option ID
	        )  
	    );

	    add_settings_field( // Option 1
	        'slideshare_icon', // Option ID
	        'Endereço do slideshare', // Label
	        'my_textbox_callback', // !important - This is where the args go!
	        'general', // Page it will be displayed (General Settings)
	        'redes_sociais', // Name of our section
	        array( // The $args
	            'slideshare_icon' // Should match Option ID
	        )  
	    );

	    register_setting('general','facebook_icon', 'esc_attr');
	    register_setting('general','linkedin_icon', 'esc_attr');
	    register_setting('general','slideshare_icon', 'esc_attr');
	}
